...
7. Runtime settings: install [mwpn/modmon-settings](https://github.com/mwpn/modmon-settings)
   for capability `settings.runtime` (`RuntimeSettingsContract`); otherwise
   use config + env. No Foundation `ContributesSettings` schema API yet.
